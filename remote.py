...
def remote_basicOperation(ip_add):
    i = 1
    while (1) :
...
def remote_packManagement(ip_add):
    while (1):
        os.system("tput setaf 1")
...
def remote_userManagement(ip_add):
    while (1):
...
def remote_serviceManagement(ip_add):
    while (1) :
...
def remote_dockerManagement(ip_add):
    while (1) :
